...
if (isset($_POST['add'])) {
  ...
  $created_by = mysqli_real_escape_string($db, $_SESSION['username']);

  $query = "INSERT INTO product (product_name,price,quantity,created_by) 
  			  VALUES('$item_name','$item_price','$quant','$created_by')";
